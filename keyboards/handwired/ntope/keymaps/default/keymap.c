...
[_QWERTY] = KEYMAP(
  KC_ESC,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_BSPC,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
  ...
  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    NUMPAD,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, KC_RSFT,
             KC_LCTL, KC_LALT, KC_RGUI,     LOWER,        RAISE,            KC_SPC,  ARROWS,  KC_RGUI, LIGHTS,   KC_ENT
),
[_RAISE] = KEYMAP(
  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL, KC_DEL,
  KC_TAB,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______,
...
[_LOWER] = KEYMAP(
  KC_TILD,   KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,         KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS, KC_DEL,
  KC_TAB,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______,
  _______,   KC_F11,  KC_F12,  _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______,
             _______, _______, _______,     _______,      _______,         _______, _______, KC_VOLD, KC_MPLY, KC_VOLU
),
